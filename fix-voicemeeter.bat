...
echo CreateObject("Wscript.Shell").Run "PowerShell.exe ""$Process = Get-Process audiodg; $Process.ProcessorAffinity=1; $Process.PriorityClass=""""""High""""""""", 2, True > "%UserProfile%\set-audiodg-affinity.vbs"
:: Affinity table
:: Core # = Value = BitMask
:: Core 0  = 1                = 00000001
:: Core 1  = 2                = 00000010
...
schtasks /create /sc MINUTE /tn audiodg-affinity-recurring /mo 60 /tr "wscript \"%UserProfile%\set-audiodg-affinity.vbs\"" /rl HIGHEST
